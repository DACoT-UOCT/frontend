    ...
    <MotionDiv className="grid-item nuevo-semaforo procesar-solicitud">
      {submit === false ? (
        <>
          ...
          <p>
            En caso de haber errores en la solicitud, esta se puede rechazar (se
            tendrá que ingresar una nueva solicitud con las correcciones
            señaladas) o puede ser aceptada y corregida por un usuario Personal
            UOCT
          </p>
          <p>
            Se puede adjuntar un comentario antes de procesar la solicitud. Este
            será enviado por correo electrónico a la empresa emisora junto con
